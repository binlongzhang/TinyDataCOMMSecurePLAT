        ...
        if (iLength <= 0xFF)
            ...
            if (iLength < 0xFFFF)
                ...
                if (iLength <= 0xFFFFFF)
                    ...
                    {
                        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, LengthErr, "func DER_ItAsn1_Low_Count_LengthOfSize() err");
                        return LengthErr;
                    }
}
...
ITCAST_INT BaseASN1::DER_ItAsn1_Low_GetLengthInfo(ITCAST_UINT8 **ppDerData, ITCAST_UINT32 **ppLengthValue, ITCAST_UINT32 **ppLengthSize)
{
    ...
    else                                //long
    {
        ...
        if (cSizeOf > 4/* ||cSizeOf <0*/)
        {
            ...
            m_log.Log(__FILE__, __LINE__, MyLog::ERROR, LengthErr, "func DER_ItAsn1_Low_GetLengthInfo() err");
            return LengthErr;
        }
        else
        {
...
ITCAST_INT BaseASN1::DER_ItAsn1_Low_WriteTagAndLength(ITCAST_ANYBUF *pAnyIn, ITCAST_UINT8 cTag, ITCAST_ANYBUF **ppAnyOut, ITCAST_UINT8 **ppUint8Value)
{
    ...
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, LengthErr, "func DER_ItAsn1_Low_WriteTagAndLength() err");
        return LengthErr;
    }
...
ITCAST_INT BaseASN1::DER_ItAsn1_WriteInteger(ITCAST_UINT32 integer, ITASN1_INTEGER **ppDerInteger)
{
    ...
    if (iResult != NoErr)
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_Low_IntToChar() err != NoErr");
        return  iResult;
    }
...
ITCAST_INT BaseASN1::DER_ItAsn1_ReadInteger(ITASN1_INTEGER *pDerInteger, ITCAST_UINT32 *pInteger)
{
    ...
    if (iResult != NoErr)
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_Low_GetLengthInfo() err");
        return  iResult;
    }
    lMidLength = *pMidSize;
    DER_ITCAST_Free(pMidSize);
    ...
    if (iResult != NoErr)
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_Low_CharToInt() err");
        return  iResult;
    }
    //输出
    *pInteger = *pMidSize;
...
ITCAST_INT BaseASN1::DER_ItAsn1_WriteBitString(ITASN1_BITSTRING *pBitString, ITASN1_BITSTRING **ppDerBitString)
{
    ...
    if (iResult != NoErr)
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_Low_WriteTagAndLength() err");
        return  iResult;
    }
...
ITCAST_INT BaseASN1::DER_ItAsn1_ReadBitString(ITASN1_BITSTRING *pDerBitString, ITASN1_BITSTRING **ppBitString)
{
    ...
    if (iResult != NoErr)
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_Low_ReadTagAndLength() err");
        return iResult;
    }
...
ITCAST_INT BaseASN1::DER_ItAsn1_WritePrintableString(ITASN1_PRINTABLESTRING *pPrintString, ITASN1_PRINTABLESTRING **ppDerPrintString)
{
    ...
    if (pPrintString->dataType == ITCAST_DER_STRING_BMP)
    {
        ...
        if (iResult != NoErr)
        {
            m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_WriteBmpString() err");
            return  iResult;
        }
    ...
    else
    {
        ...
        if (iResult != NoErr)
        {
            m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_WriteCharString() err");
            return  iResult;
        }
    }
...
ITCAST_INT BaseASN1::DER_ItAsn1_ReadSequence(ITCAST_ANYBUF *pDerSequence, ITASN1_SEQUENCE **ppSequence)
{
    ...
    if (iResult != NoErr)
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, iResult, "func DER_ItAsn1_Low_GetTagInfo() err");
        return  iResult;
    }
    ...
    if (lTotalLength != 0)
    {
        m_log.Log(__FILE__, __LINE__, MyLog::ERROR, LengthErr, "lTotalLength != 0 err");
